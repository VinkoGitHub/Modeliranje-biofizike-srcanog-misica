...
st.divider()
centered_image("presentation/data/figures/provodni-sustav.jpg", width=1.5, caption="caption")
st.divider()
bullet(
...
st.divider()
centered_image("presentation/data/figures/EKG-slika.jpg", width=5, caption="caption")
st.divider()
bullet("Akcijski potencijal", "Polarizacija", "Depolarizacija", "Repolarizacija")
st.divider()
centered_image(
    "presentation/data/figures/akcijski-potencijal-slika.jpg", width=5, caption="caption"
)
st.divider()
bullet(
...
st.divider()
centered_image("presentation/data/figures/akcijski_potencijali.jpg", width=4, caption="caption")